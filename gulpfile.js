  ...
  return gulp.src('./source/scss/**/*.scss')
    ...
    .pipe($.sass({
    	...
    	includePaths: [
    		...
    		'./vendors/eonasdan-bootstrap-datetimepicker/src/sass/',
...
gulp.task('bower', function() {
  return gulp.src(mainBowerFiles({
  	"overrides": {
        ...
        "bootstrap-fileinput": {
						"main": ["js/fileinput.min.js","js/locales/zh-TW.js","scss/fileinput.scss"]
        },
        "moment": {
						"main": ["min/moment-with-locales.js"]
        },
        "eonasdan-bootstrap-datetimepicker": {
						"main": ["build/js/bootstrap-datetimepicker.min.js","src/sass/bootstrap-datetimepicker-build.scss"]
        },
        "sweetalert2": {
